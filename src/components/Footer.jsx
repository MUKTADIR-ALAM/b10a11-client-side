      ...
      <footer className="footer bg-base-300 text-base-content p-10">
        <nav>
          ...
          <div className="grid grid-flow-col gap-4">
            <a href="https://x.com/mukta010101" target="_blank">
              <svg
            ...
            <a href="https://www.youtube.com/@muktadir1010" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <a
              href="https://www.facebook.com/profile.php?id=61561098160366"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <nav>
          ...
          <a className="link link-hover">
            Street: motijheel c/a, <br /> City: Dhaka <br />
